...
echo "#define IMPACK_CONFIG_ZLIB $9"
shift 9
echo "#define IMPACK_CONFIG_ZSTD $1"
echo "#define IMPACK_CONFIG_LZMA $2"
echo "#define IMPACK_CONFIG_BZIP2 $3"
echo "#define IMPACK_CONFIG_BROTLI $4"
echo
echo "#endif"
