...
echo "#define IMPACK_CONFIG_ZLIB $8"
echo "#define IMPACK_CONFIG_ZSTD $9"
shift 9
echo "#define IMPACK_CONFIG_LZMA $1"
echo "#define IMPACK_CONFIG_BZIP2 $2"
echo "#define IMPACK_CONFIG_BROTLI $3"
echo
echo "#endif"
